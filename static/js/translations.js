/**
 * Multi-language support for Peixe no Largo & Lapicanha website.
...
const TRANSLATIONS = {
  en: {
    ...
    about_p2_casa: "Peixe no Largo brings you the freshest catch from the Atlantic \u2014 sea bream, cod, octopus, prawns \u2014 cooked with recipes passed down through generations of coastal cooks.",
    ...
    visit_sub: "Both restaurants are located on Rua/Largo Jos\u00e9 Afonso \u2014 come for lunch at Peixe no Largo, return for dinner at Lapicanha.",
    ...
    footer_copyright: "Peixe no Largo & Lapicanha \u00b7 Set\u00fabal, Portugal. All rights reserved.",
  ...
  pt: {
    ...
    about_p2_casa: "O Peixe no Largo traz-lhe o mais fresco do Atl\u00e2ntico \u2014 dourada, bacalhau, polvo, cama\u00e3o \u2014 cozinhados com receitas transmitidas por gera\u00e7\u00f5es de cozinheiros costeiros.",
    ...
    visit_sub: "Ambos os restaurantes est\u00e3o localizados na Rua/Largo Jos\u00e9 Afonso \u2014 venha almo\u00e7ar no Peixe no Largo e volte para jantar no Lapicanha.",
    ...
    footer_copyright: "Peixe no Largo & Lapicanha \u00b7 Set\u00fabal, Portugal. Todos os direitos reservados.",
  ...
  es: {
    ...
    about_p2_casa: "Peixe no Largo le trae lo m\u00e1s fresco del Atl\u00e1ntico \u2014 dorada, bacalao, pulpo, gambas \u2014 cocinado con recetas transmitidas por generaciones de cocineros costeros.",
    ...
    visit_sub: "Ambos restaurantes est\u00e1n ubicados en Rua/Largo Jos\u00e9 Afonso \u2014 venga a almorzar al Peixe no Largo y vuelva a cenar al Lapicanha.",
    ...
    footer_reservations: "Reservas",
    footer_copyright: "Peixe no Largo & Lapicanha \u00b7 Set\u00fabal, Portugal. Todos los derechos reservados.",
  ...
  fr: {
    ...
    about_p2_casa: "Peixe no Largo vous apporte le plus frais de l'Atlantique \u2014 dorade, morue, poulpe, crevettes \u2014 cuisin\u00e9s avec des recettes transmises par des g\u00e9n\u00e9rations de cuisiniers c\u00f4tiers.",
    ...
    visit_sub: "Les deux restaurants sont situ\u00e9s sur Rua/Largo Jos\u00e9 Afonso \u2014 venez d\u00e9jeuner au Peixe no Largo, revenez d\u00eener au Lapicanha.",
    ...
    footer_copyright: "Peixe no Largo & Lapicanha \u00b7 Set\u00fabal, Portugal. Tous droits r\u00e9serv\u00e9s.",
...
function applyTranslations(lang) {
  ...
  // Update elements with data-i18n-append (text + dynamic suffix, e.g. "Discover Peixe no Largo")
